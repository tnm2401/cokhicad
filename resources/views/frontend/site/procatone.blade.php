            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 main-content">
                <nav aria-label="breadcrumb" style="margin-top: 10px">
                    <ol class="breadcrumb shadow-sm">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}" title="{{ $setting->translations->name }}"><i class="ti-home"></i> Trang chủ</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('frontend.slug',$menu['tat-ca-san-pham']->translations->slug) }}" title="{{ $setting->translations->name }}"><i class="ti-home"></i> Sản phẩm</a></li>
                        <li class="breadcrumb-item">{{ $procatone->translations->name }}</li>
                    </ol>
                </nav>
