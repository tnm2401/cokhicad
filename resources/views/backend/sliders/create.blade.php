...
@section('title','Thêm Slider | Hình ảnh')
@section('content')
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en" id="tab_{{ $lang->locale }}">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="translation[{{ $lang->locale }}][name]" value="{{ old('translation.'.$lang->locale.'.name') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập tiêu đề hình ảnh ({{ $lang->locale }})">
                                </div>
                                {{-- <div class="form-group">
                                    <label>Mô tả ({{ $lang->locale }})</label>
                                    <input type="text" name="translation[{{ $lang->locale }}][content]" value="{{ old('translation.'.$lang->locale.'.content') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Mô tả ({{ $lang->locale }})">
                                </div> --}}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                data-placement="top" title="Dimensions min 1440 x 520 (px)" oninput="imgpreview.src=window.URL.createObjectURL(this.files[0])">
                            </div>
                        </div>
                    </div>
                    <div class="box box-primary">
