...
@section('title','Thêm danh mục cấp 3 | Sản phẩm')
@section('content')
<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" id="pjax-container">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h4>Thêm danh mục cấp 3</h4>
        <ol class="breadcrumb">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en" id="tab_{{ $lang->locale }}">
                                ...
                                <div class="form-group">
                                    <select class="form-control choose procatone select2" name="procatone" id="procatone" data-placeholder=" Chọn danh mục cấp 1" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    <select class="form-control select2 choose procattwo" name="procattwo" id="procattwo" data-placeholder=" Chọn danh mục cấp 1 trước" style="width: 100%;">
                                    </select>
                                </div>
                                @endif
                                <div class="form-group">
