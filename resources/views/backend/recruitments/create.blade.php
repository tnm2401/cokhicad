...
@section('title','Thêm tin tuyển dụng | Tuyển dụng')
@section('content')
...
<div class="content-wrapper" id="pjax-container">
    ...
    <section class="content">
        <form id="stringLengthForm" method="POST" action="{{ route('backend.recruitment.store') }}" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en" id="tab_{{ $lang->locale }}">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="translation[{{ $lang->locale }}][name]" id="name_{{ $lang->locale }}" onkeyup="AutoSlug();" value="{{ old('translation.'.$lang->locale.'.name') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập tên bài viết ({{ $lang->locale }})">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="translation[{{ $lang->locale }}][slug]" id="slug_{{ $lang->locale }}" value="{{ old('translation.'.$lang->locale.'.slug') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập URL bài viết ({{ $lang->locale }})">
                                    </div>
                                    <div class="form-group">
                                        <label>Tiêu đề</label>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                data-placement="top" title="Dimensions min 370 x 250 (px)" oninput="imgpreview.src=window.URL.createObjectURL(this.files[0])">
                            </div>
                        </div>
                    </div>
                    <div class="box box-primary">
