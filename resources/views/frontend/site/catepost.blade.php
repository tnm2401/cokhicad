            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 main-content">
                <nav aria-label="breadcrumb" style="margin-top: 10px">
                    <ol class="breadcrumb shadow-sm">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('frontend.slug',$menu['tat-ca-bai-viet']->translations->slug) }}" title="{{ $menu['tat-ca-bai-viet']->translations->title }}"><i
                                    class="ti-home"></i>{{ __('Bài viết') }}</a></li>
                        <li class="breadcrumb-item">{{ $newcatone->translations->name }}</li>

                    </ol>
                </nav>
                <div class="main-title text-center mb-5">
                    <h1 class="title font-weight-bold">{{ $newcatone->translations->name }}</h1>
                </div>
