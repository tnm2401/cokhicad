                                ...
                                <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en" id="tab_{{$lang->locale}}">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="translation[{{$key}}][name]" id="name_{{ $lang->locale }}" onkeyup="AutoSlug();"
                                                value="{{ old('translation.'.$lang->locale.'.name') }}" class="form-control" data-toggle="tooltip"
                                                data-placement="top" title="Nhập tên danh mục">
                                        </div>
                                        <div class="form-group">
                                            <label>Mô tả ({{ $lang->locale }})</label>
                                            <textarea class="form-control" name="translation[{{ $lang->locale }}][descriptions]" id="descriptions_{{ $lang->locale }}" rows="6" data-toggle="tooltip" data-placement="top" title="Nhập mô tả dịch vụ ({{ $lang->locale }})">{{ old('translation.'.$lang->locale.'.descriptions') }}</textarea>
                                          </div>
                                    <div class="box-header with-border">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="translation[{{$key}}][slug]" id="slug_{{ $lang->locale }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="translation[{{$key}}][keywords]" id="keywords_{{ $lang->locale }}"
                                                value="{{ old('translation['.$key.'][keywords]') }}" rows="6" data-toggle="tooltip"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="translation[{{$key}}][description]" id="des_{{ $lang->locale }}"
                                                value="{{ old('translation['.$key.'][description]') }}" rows="6" data-toggle="tooltip"
