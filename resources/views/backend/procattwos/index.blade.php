...
@section('title','Danh mục cấp 2 | Sản phẩm')
@section('content')
            ...
            <table id="procattwos" class="table table-bordered table-striped set__width">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <strong><a href="{{ route('backend.procattwo.edit', $procattwo->id ) }}">{{ $procattwo->translations->name ?? '' }}</a></strong>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <form class="d-inline" method="POST" action="{{ route('backend.procattwo.destroy', $procattwo->id) }}" >
                      @csrf
                      {{ method_field('DELETE') }}
