                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <textarea class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập mô tả nhóm và quyền" name="description" rows="6">{!! old('translation'.'.description') !!}</textarea>
                                </div>
