...
@section('title','Thêm danh mục cấp 1 | Tin tức')
@section('content')
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="{{ $loop->first ? 'active' : '' }}"><a href="#tab_{{ $lang->locale }}" data-toggle="tab"><span class="{{ $lang->flag }}"></span> {{ $lang->name }}({{ $lang->locale }})</a></li>
              @endforeach
