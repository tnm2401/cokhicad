                                ...
                                <tbody id="show-content-search">
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td><strong><a
                                                        href="{{ route('backend.order.edit', $order->id) }}">{{ $order->name }}</a></strong>
                                            </td>
                                            <td>{{ $order->phone }}</td>
                                            <td>{{ date('d/m/Y', strtotime($order->created_at)) }}</td>
                                            <td>{{ product_price_view($order->orderdetail->sum('total_item')) ?? '' }}₫
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" data-toggle="tooltip" data-placement="top"
                                                    title="Sửa"
                                                    href="{{ route('backend.order.edit', $order->id) }}"><i
                                                        class="fa fa-edit"></i></a>
                                                <form class="d-inline" method="POST"
                                                    action="{{ route('backend.order.destroy', $order->id) }}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
