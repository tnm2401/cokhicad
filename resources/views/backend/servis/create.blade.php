...
@section('title', 'Thêm dịch vụ | Dịch vụ')
@section('content')
...
<div class="content-wrapper" id="pjax-container">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Tin tức</li>
            <li><a href="{{ route('backend.post.index') }}">Quản lý dịch vụ</a></li>
            ...
            <div class="row">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en" id="tab_{{ $lang->locale }}">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="translation[{{ $lang->locale }}][name]" id="name_{{ $lang->locale }}" onkeyup="AutoSlug();" value="{{ old('translation.'.$lang->locale.'.name') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập tên tin tức ({{ $lang->locale }})">
                                </div>
                                @if ($loop->first)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 choose svcate" name="svcate" id="svcate" style="width: 100%;">
                                        ...
                                        @foreach ($svcates as $k => $svcate)
                                        <option value="{{ $svcate->id }}">{{ $svcate->translations->name ?? '' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="translation[{{ $lang->locale }}][descriptions]" id="descriptions_{{ $lang->locale }}" rows="6" data-toggle="tooltip" data-placement="top" title="Nhập mô tả ({{ $lang->locale }})">{{ old('translation.'.$lang->locale.'.descriptions') }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="translation[{{ $lang->locale }}][title]"
                                        id="title_{{ $lang->locale }}" value="{{ old('translation.'.$lang->locale.'.title') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập tiêu đề ({{ $lang->locale }})">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Mô tả ({{ $lang->locale }})</label>
                                        <textarea class="form-control" name="translation[{{ $lang->locale }}][description]" id="des_{{ $lang->locale }}" rows="6" data-toggle="tooltip" data-placement="top"
                                        title="Nhập mô tả ({{ $lang->locale }})">{{ old('translation.'.$lang->locale.'.description') }}</textarea>
                                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <label>
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" class="cbc" {{ old('is_featured') == '1' ? 'checked' : '' }}>
