                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 cart__footer">
                        <div class="solid-border">
                          ...
                          <div class="row border-bottom pb-2 pt-2">
                            ...
                            <span class="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right"><span class="money" id="total_price_cart">{{ number_format($cart->total_price) }}</span></span>
                          </div>
