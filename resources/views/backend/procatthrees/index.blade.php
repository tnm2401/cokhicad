...
@section('title','Danh mục cấp 3 | Sản phẩm')
@section('content')
          ...
          <div class="box-body">
            <table id="procatthrees" class="table table-bordered table-striped set__width">
              ...
              <tbody>
                ...
                <td>
                  <strong><a href="{{ route('backend.procatthree.edit', $procatthree->id ) }}">{{ $procatthree->translations->name ?? '' }}</a></strong>
                </td>
                <td>
                ...
                <td>
                  ...
                  <form class="d-inline" method="POST" action="{{ route('backend.procatthree.destroy', $procatthree->id) }}"  >
                    @csrf
                    {{ method_field('DELETE') }}
